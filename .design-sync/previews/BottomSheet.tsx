...
/* Generic "no photo" placeholder - neutral surface + the design system's own
   camera icon, standing in for real photography/artwork. Never an emoji glyph
   (see .design-sync/NOTES.md rule #1). Icon props always take a real
   SnackyIcons glyph separately. */
  ...
  return (
    <div style={stage}>
      <BottomSheet open onDismiss={() => {}}>
        <div style={body}>
          <Illustration variant="welcome" src={placeholder(200, 200)} alt="" />
          <div style={centred}>
...
export function Success() {
  return (
    <div style={stage}>
      <BottomSheet open onDismiss={() => {}}>
        <div style={body}>
          <Illustration variant="success" src={placeholder(200, 200)} alt="" />
          <div style={centred}>
    ...
    <div style={stage}>
      <BottomSheet open onDismiss={() => {}}>
        ...
        >
          ...
          <ProductImage src={placeholder(90, 90)} alt="Snack" usage="variant" />
